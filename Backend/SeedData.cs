...
public class SeedData
{
    ...
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        var userId = seedUsers.Select(e => e.Id).FirstOrDefault() ?? string.Empty;

        context.Add(new TodoItem { UserId = userId, ActivityNo = "AC-0001", Subject = "Lift weights", Mark = Mark.Solved });
        context.Add(new TodoItem { UserId = userId, ActivityNo = "AC-0002", Subject = "Feed Merlin", Mark = Mark.Unmarked });
        context.Add(new TodoItem { UserId = userId, ActivityNo = "AC-0003", Subject = "Update web API article", Mark = Mark.Unmarked });
        context.Add(new TodoItem { UserId = userId, ActivityNo = "AC-0004", Subject = "Attend Blazor party", Mark = Mark.Canceled });
